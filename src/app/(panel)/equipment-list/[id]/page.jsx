...
export default function ConveyorViewDetails() {
  const [openConveyorNoteModal, setOpenConveyorNoteModal] = useState(false);
  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        <Card>
          ...
          <div className="mt-10">
            ...
            <div className="relative size-52 px-2 py-3  rounded-lg border border-zinc-100  overflow-hidden">
              <div className="z-10 absolute inset-0 bg-black/50 flex justify-center items-center gap-4">
                <div className="btn bg-zinc-700 text-white text-xs h-9 p-2">
                  <IconEye size={20} />
                  View
                </div>
              </div>
          ...
          <div className="flex items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              <button
                ...
                onClick={() => setOpenConveyorNoteModal(true)}
              >
                <IconEdit />
                Add Note
              </button>
      ...
      <Modal
        // title={selectedId ? "Note Details" : "Add Note"}
        title="Note Details"
        open={openConveyorNoteModal}
        onClose={() => {
          setOpenConveyorNoteModal(false);
        }}
      >
        <ConveyorNoteModal />
      </Modal>
